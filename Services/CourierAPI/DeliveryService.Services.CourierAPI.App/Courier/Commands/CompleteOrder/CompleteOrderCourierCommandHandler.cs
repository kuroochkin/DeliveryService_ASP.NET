...
using DeliveryService.Services.CourierAPI.App.Courier.Commands.ConfirmOrder;
using ErrorOr;
using MediatR;

namespace DeliveryService.Services.CourierAPI.App.Courier.Commands.CompleteOrder;

public class CompleteOrderCourierCommandHandler
	: IRequestHandler<ConfirmOrderCourierCommand, ErrorOr<bool>>
{
	private readonly IUnitOfWork _unitOfWork;
	private readonly IRabbitMQCompleteOrderByCourierSender _rabbitMqSender;

	public CompleteOrderCourierCommandHandler(
		IUnitOfWork unitOfWork,
		IRabbitMQCompleteOrderByCourierSender rabbitMqSender)
	{
		...
		CancellationToken cancellationToken)
	{
		...
		_rabbitMqSender.SendMessage(completeOrderMessage, "CourierAPI: CompleteOrderByCourier");
