...
public class RabbitMQChangePaymentStatusConsumer : BackgroundService
{
	...
	public RabbitMQChangePaymentStatusConsumer(IServiceProvider serviceProvider)
	{
		...
		_channel.QueueDeclare(queue: "PaymentAPI: ChangePaymentStatusQueue", false, false, false, arguments: null);
	}
	...
	protected override Task ExecuteAsync(CancellationToken stoppingToken)
	{
		...
		_channel.BasicConsume("PaymentAPI: ChangePaymentStatusQueue", false, consumer);
